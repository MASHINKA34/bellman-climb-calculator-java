...
// данные самолёта; значения условные, всё правится через форму
//#инкапсуляция - поля private, доступ через геттеры и сеттеры
public class Aircraft {
    ...
    //#валидация - отсекаем бессмысленные данные до начала расчёта
    ...
    // чтобы не писать if-throw на каждую проверку
